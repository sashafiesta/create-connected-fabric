...
public class CCStandardRecipes extends BaseRecipeProvider {
    ...
    GeneratedRecipe copycat(ItemProviderEntry<? extends ItemLike> result, int resultCount) {
        ...
        return create(result)
                ...
                .requiresResultFeature()
                .disabledInCopycats()
                .viaStonecutting(DataIngredient.tag(CCTags.commonItemTag("zinc_ingots")), resultCount);
    }
    ...
    class GeneratedRecipeBuilder {
        ...
        GeneratedRecipeBuilder disabledInCopycats() {
            return withCondition(DefaultResourceConditions.not(new FeatureEnabledInCopycatsCondition(CatnipServices.REGISTRIES.getKeyOrThrow(result.get().asItem()))));
        }
        ...
        GeneratedRecipe viaShaped(UnaryOperator<ShapedRecipeBuilder> builder) {
            return register(consumer -> {
                ...
                b.save(result -> consumer.accept(!recipeConditions.isEmpty()
                        ? new ConditionSupportingRecipeResult(result, recipeConditions)
    ...
    private record ConditionSupportingRecipeResult(FinishedRecipe wrapped,
                                                   List<ConditionJsonProvider> conditions) implements FinishedRecipe {
