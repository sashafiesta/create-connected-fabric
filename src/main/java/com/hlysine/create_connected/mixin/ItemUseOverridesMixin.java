...
public class ItemUseOverridesMixin {
    @WrapOperation(
            method = "onBlockActivated(Lnet/minecraft/world/entity/player/Player;Lnet/minecraft/world/level/Level;Lnet/minecraft/world/InteractionHand;Lnet/minecraft/world/phys/BlockHitResult;)Lnet/minecraft/world/InteractionResult;",
    ...
    private static InteractionResult preciseHitLocation(BlockState instance,
        ...
        if (PreciseItemUseOverrides.OVERRIDES.contains(id)) {
            HitResult preciseHitResult = player.pick(com.simibubi.create.foundation.utility.fabric.ReachUtil.reach(player), 1, false);
